...
{
    public class MongoDBPlusStorageInitializer : IStorageInitializer
    {
        private readonly IMongoClient _client;
        private readonly ILogger _logger;
        private readonly IOptions<MongoDBOptions> _options;

        public MongoDBPlusStorageInitializer(
            ILogger<MongoDBPlusStorageInitializer> logger,
            IMongoClient client,
        ...
        public async Task InitializeAsync(CancellationToken cancellationToken)
        {
            ...
            {
                var indexNames = new[] {"Name", "Added", "ExpiresAt", "LastUpdated", "NextRetryAt", "StatusName", "Retries", "Version"};

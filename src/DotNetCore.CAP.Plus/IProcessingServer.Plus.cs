...
{
    public class CapPlusProcessingServer : IProcessingServer
    {
        ...
        public CapPlusProcessingServer(
            ILogger<CapPlusProcessingServer> logger,
        ...
        private IProcessor[] GetProcessors()
        {
            var returnedProcessors = new List<IProcessor>
            {
                ...
                _provider.GetRequiredService<PublishedMessageNeedToRetryProcessor>(),
                _provider.GetRequiredService<ReceivedMessageNeedToRetryProcessor>(),
